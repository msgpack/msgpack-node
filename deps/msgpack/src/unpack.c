...
#endif
    /* node-msgpack: conservative container cap (defense in depth). */
#ifndef MSGPACK_NODE_MAX_CONTAINER
#define MSGPACK_NODE_MAX_CONTAINER 1000000u
#endif
    if (n > MSGPACK_NODE_MAX_CONTAINER)
